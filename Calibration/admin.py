...
class Resource2(resources.ModelResource):
    ...
    class Meta:
        model = Fixture_List
        fields = ('id','Customer','Product_description','Sub_Assembly','Fixture_or_Template_ID','Description','Location_used','Verification_Freq','Verification_Plan','Verified_on','Next_Verification_Due','Verification_report1','Verification_report2','Status','Remarks','FN')
...
class Admin1(ImportExportModelAdmin,admin.ModelAdmin):
    ...
    class Meta:
        model = Fixture_List
    list_display = ['Customer','Product_description','Sub_Assembly','Fixture_or_Template_ID','Description','Location_used','Verification_Freq','Verification_Plan','Verified_on','Next_Verification_Due','Status','Verification_report1','Verification_report2','Remarks']
    list_editable = ['Product_description','Sub_Assembly','Fixture_or_Template_ID','Description','Location_used','Verification_Freq','Verification_Plan','Verified_on','Verification_report1']
